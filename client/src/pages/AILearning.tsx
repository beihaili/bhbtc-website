...
const businessHeadshotPrompt = `请基于我上传的人像照片生成一张正式商务档案头像海报。保留人物真实身份特征、五官比例、脸型基础和整体气质，不要改变人物身份。
...
画面为正面半身肖像，人物居中，直视镜头，表情自然自信。背景为纯白色素色背景，光线柔和均匀，类似专业证件照、企业头像摄影或大学官网个人档案照。整体风格干净、正式、商务、高清写实摄影质感，方形比例 1:1。
...
const promptLibrary = [
  ...
  },
  {
    title: "商务证件照头像海报提示词",
    usage:
      "上传一张清晰正脸照，生成正式商务头像海报。适合做职场人设、企业档案照、大学官网风个人主页图。",
    prompt: businessHeadshotPrompt,
  },
  {
    title: "医美微整容前后对比图提示词",
    usage:
          ...
          <div className="container">
            <div className="mx-auto mb-10 max-w-3xl text-center">
              ...
              <p className="mt-4 text-[#7a625c] dark:text-[#dec8c0]">
                上传一张照片，复制提示词，就能生成适合小红书发布的效果图、信息图和人设海报。
              </p>
            </div>
